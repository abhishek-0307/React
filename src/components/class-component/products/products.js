    ...
    reset =(data)=>{
        let result=this.state.products.map((eachObject)=>{
            if(eachObject.id===data.id){
                ...
                let newObject={...eachObject,rating:{
                    ...eachObject.rating,count:eachObject.rating.count=0
                }}
                return newObject;
            }else{
            ...
            this.state.products.map((eachObject)=>{
                return(
                    <div key={eachObject.id} >
                        <ProductListing  data={eachObject}  increment={this.increment}  decrement={this.decrement} reset={this.reset} />
                        </div>
                )
            })
         }
    ...
    render(){
        ...
        return(
            <div>
                 ...
                 <h3><img src={this.props.data.image} height={100} width={100}></img></h3>
